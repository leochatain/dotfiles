...
export JAVA_HOME=$(/opt/homebrew/opt/openjdk/bin/java -XshowSettings:properties -version 2>&1 > /dev/null | grep "java.home" | awk "{print $3}")


# cargo stuff
export PATH="/Users/leo/.cargo/bin:$PATH"
